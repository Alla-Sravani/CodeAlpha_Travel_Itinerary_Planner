...
class travelDestination{  
    ...
    int d;      
        void selectDestination()
        {
            ...
            if(d==1)
            {
                System.out.println("Your Selected Destination is Barcelona ");
            }
            else if(d==2)
            {
                System.out.println("Your Selected Destination is London ");
            }
            else if(d==3)
            {
                System.out.println("Your Selected Destination is France ");
            }
            else if(d==4)
            {
                System.out.println("Your Selected Destination is Istanbul ");
            }
            else
            {
